...
export default function BlogDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-surface pb-20">
      ...
      <title>{post.title} - MediStore Blog</title>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Share this article */}
        <div className="max-w-3xl mx-auto mt-12 pt-8 border-t border-outline flex items-center gap-3 flex-wrap">
          <span className="text-sm font-semibold text-on-surface mr-2">Share:</span>
          <a
            href={`https://wa.me/?text=${encodeURIComponent(post.title + ' — ' + window.location.href)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-sm text-sm font-medium bg-[#25D366] text-white hover:opacity-90 transition-opacity"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-sm text-sm font-medium bg-[#1877F2] text-white hover:opacity-90 transition-opacity"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-sm text-sm font-medium bg-black text-white hover:opacity-90 transition-opacity"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-sm text-sm font-medium bg-[#0A66C2] text-white hover:opacity-90 transition-opacity"
          >
