        ...
        <div className="flex items-center justify-between px-6 py-4 border-b bg-gray-50 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Official HealthTracker Document</p>
            </div>
          </div>
        ...
        <div className="overflow-y-auto flex-1">
          <div ref={printRef}>
            ...
            <div className="text-center border-b-2 border-gray-300 pb-6 mb-6 px-8 pt-8">
              <p className="text-xs tracking-[0.2em] text-gray-500 uppercase mb-1">HealthTracker</p>
              <h1 className="text-xl font-bold text-gray-900">Digitized Medical Report</h1>
              <p className="text-xs text-gray-400 mt-1">Report ID: HT-{reportId}-{new Date().getFullYear()}</p>
            </div>
            ...
            <div className="px-8 pb-8 space-y-6">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                <p className="text-xs font-mono text-gray-500">Verification Code: HT-{reportId}-{user.id.slice(-4)}</p>
                <p className="text-xs text-gray-400 mt-1">Generated by HealthTracker &mdash; Digitized Medical Report</p>
              </div>

              {/* Footer */}
              <div className="text-center text-xs text-gray-400 pt-4 border-t border-gray-200">
                <p>HealthTracker &mdash; Personal Digital Health Tracker</p>
