/// The design-system gallery — every token and component on one screen.
///
/// Not part of the app: it has its own `main()` so the system can be reviewed
/// on a device without signing in, and `design_review_test.dart` renders it at
/// 1.0x, 1.5x and 2.0x text scale in both themes to catch clipping.
///
